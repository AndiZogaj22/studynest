    ...
    <div class="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4 bg-inherit">
          ...
          <img class="h-16 w-auto transition-transform transform hover:scale-110" src="../assets/logo.png" alt="">
                ...
                <div class="sm:ml-0 ml-8 flex flex-col">
                    ...
                    <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Courses</a>
                    ...
                    <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Newsletter</a>
                </div>
